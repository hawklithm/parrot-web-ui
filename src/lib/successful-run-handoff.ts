import type { ActivityEvent, Issue, SuccessfulRunHandoffState } from "../lib/paperclip-shared/src";
...
export const SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY =
  "Parrot needs a disposition before this issue can continue.";
export const SUCCESSFUL_RUN_HANDOFF_EXHAUSTED_NOTICE_BODY =
  "Parrot could not resolve this issue's missing disposition automatically. The issue is blocked on a recovery owner.";
