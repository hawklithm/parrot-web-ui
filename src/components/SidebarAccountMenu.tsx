...
import type { DeploymentMode } from "../lib/paperclip-shared/src";
          ...
          <div className="-mt-8 px-4 pb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 pt-1">
                ...
                {version ? (
                  <p className="mt-1 text-xs text-muted-foreground">Parrot v{version}</p>
                ) : null}
              </div>
            </div>
            ...
            <div className="mt-4 space-y-1">
              ...
              <MenuAction
                label="Documentation"
                description="Open Parrot docs in a new tab."
                icon={BookOpen}
                href={DOCS_URL}
                external
