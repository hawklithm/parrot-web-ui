...
import { AGENT_DEFAULT_MAX_CONCURRENT_RUNS, supportedEnvironmentDriversForAdapter } from "../lib/paperclip-shared/src";
...
// Canonical type lives in parrot-adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "../lib/paperclip-adapter-utils/src";
