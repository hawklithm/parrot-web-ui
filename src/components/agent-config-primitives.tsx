...
import { AGENT_ROLE_LABELS } from "../lib/paperclip-shared/src";
...
export const help: Record<string, string> = {
  ...
  workspaceStrategy: "How Parrot should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  bootstrapPrompt: "Only sent when Parrot starts a fresh session. Use this for stable setup guidance that should not be repeated on every heartbeat.",
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Parrot adds its standard wake and workspace fields.",
