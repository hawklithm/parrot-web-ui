...
import type { DocumentRevision, Issue, IssueDocument } from "../lib/paperclip-shared/src";
import { ISSUE_CONTINUATION_SUMMARY_DOCUMENT_KEY } from "../lib/paperclip-shared/src";
