 ...
 * that one resource to Parrot's newest shipped default without touching
...
function resourceActionCopy(
  ...
  if (resource.stockStatus === "stock_update_available") {
    return {
      ...
      body: `You haven't edited this, so Parrot will replace it with the newer shipped version. Nothing you customized is affected, and your adapter credentials and settings are not touched.`,
      confirmLabel: "Update",
      triggerLabel: "Update",
    };
  }
  if (resource.stockStatus === "operator_modified") {
    return {
      ...
      body: `This replaces your edited version with Parrot's current default. Your edits can't be recovered. Adapter credentials and settings are not touched.`,
  ...
  if (resource.stockStatus === "missing") {
    return {
      ...
      body: `This resource is missing. Parrot will recreate it from the shipped default. Adapter credentials and settings are not touched.`,
...
function driftDetail(resource: BuiltInManagedResourceState): string | undefined {
  switch (resource.stockStatus) {
    ...
    case "stock_update_available":
      return "Parrot shipped a newer default.";
    case "missing":
              ...
              <>
                {onRunRoutine && (
                  <ConfirmActionButton
                    ...
                    body="Parrot will create one routine task now. This does not enable the weekly schedule or turn on background work."
                ...
                {scheduleEnabled
                  ? onDisableSchedule && (
                    <ConfirmActionButton
                      ...
                      body="Parrot will stop future scheduled Reflection Coach runs. Manual Run once remains available."
                  ...
                  : onEnableSchedule && (
                    <ConfirmActionButton
                      ...
                      body="Parrot will allow Reflection Coach to create routine tasks on the weekly schedule. It can spend tokens when those tasks run."
