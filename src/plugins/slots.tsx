 ...
 *
 * Plugin bundles are built with `external: ["parrot-plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "parrot-plugin-sdk/ui";
 ...
 * - `import { ... } from "parrot-plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"parrot-plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'parrot-plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"parrot-plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'parrot-plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `parrot-plugin-sdk/ui`, `react`, and `react-dom` resolve to the
