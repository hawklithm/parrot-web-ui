...
function sourceMeta(sourceBadge: CompanySkillSourceBadge, sourceLabel: string | null) {
  ...
  switch (sourceBadge) {
    ...
    case "paperclip":
      return { icon: Paperclip, label: sourceLabel ?? "Parrot", managedLabel: "Parrot managed" };
    default:
...
function CompatChip({ compatibility }: { compatibility: CompanySkillCompatibility }) {
  ...
  const map = {
    unknown: {
      ...
      tooltip: "Parrot could not validate this skill as Agent Skills markdown. Install at your own risk.",
...
function buildDiscoveryCards(
  ...
  for (const entry of catalog) {
    ...
    cards.push({
      ...
      name: entry.name,
      slug: entry.slug,
      author: entry.packageName ?? "Parrot",
...
export function CompanySkills() {
  ...
  const createSkill = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        ...
        body: `${skill.name} is now editable in the Parrot workspace.`,
      });
    },
    onError: (error) => {
  ...
  const studioDescription = studioForkFromId
    ...
    : "Create an editable company skill in the Parrot workspace.";
    ...
    <>
      ...
      {selectedCompanyId ? (
        <ImportSkillsFromProjectDialog
          ...
          onClose={() => setProjectImportDialogOpen(false)}
        />
      ) : null}
      ...
      {isStudioNew ? (
        ...
        <DiscoveryGrid
          ...
          onImportFromProject={() => setProjectImportDialogOpen(true)}
