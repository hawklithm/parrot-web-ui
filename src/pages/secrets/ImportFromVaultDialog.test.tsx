...
describe("ImportFromVaultDialog", () => {
  ...
  it("blocks import when a review row collides with an existing Parrot secret", async () => {
    ...
    expect(document.body.textContent?.toLowerCase()).toContain("a parrot secret already uses this");
