...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "../lib/paperclip-shared/src";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Parrot file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Parrot storage.";
