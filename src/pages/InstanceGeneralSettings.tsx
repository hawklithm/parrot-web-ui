...
import type { PatchInstanceGeneralSettings, BackupRetentionPolicy } from "../lib/paperclip-shared/src";
import {
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              ...
              Parrot Labs. Votes are always saved locally.
            </p>
            {FEEDBACK_TERMS_URL ? (
              <a
      ...
      <Card className="block p-5">
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              Sign out of this Parrot instance. You will be redirected to the login page.
            </p>
          </div>
          <Button
            variant="outline"
