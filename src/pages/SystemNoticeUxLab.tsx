        ...
        <div className="grid gap-6 lg:grid-cols-(--gtc-39)">
          <div className="p-6 sm:p-7">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
              Replaces the current pattern where a Parrot-authored warning renders inside a user-style
        ...
        >
          <div className="space-y-3 rounded-2xl border border-border/70 bg-background/70 p-4">
            ...
            <p className="px-1 text-xs text-muted-foreground">
              ...
              author is the Parrot system. Two containers stack the warning inside a user-style
