  ...
  return (
    <>
      ...
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-(--tracking-caps) text-zinc-500">You&apos;ve been invited to join Parrot</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? "Start with a Parrot account. After that, you'll come right back here to accept the invite for Acme Robotics."
        ...
        <div className="flex min-h-(--sz-420px) flex-col justify-center bg-background px-8 py-10">
          <div className="mx-auto w-full max-w-md">
            ...
            <h3 className="text-xl font-semibold">
              {mode === "sign_in" ? "Sign in to Parrot" : "Create your Parrot account"}
            </h3>
          ...
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description="Create your Parrot account first. If you already have one, switch to sign in and continue the invite with the same email."
