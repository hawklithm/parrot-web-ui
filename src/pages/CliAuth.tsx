...
export function CliAuthPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <Card className="block p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The Parrot CLI can now finish authentication on the requesting machine.
          </p>
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <Card className="block p-6">
        <h1 className="text-xl font-semibold">Approve Parrot CLI access</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          A local Parrot CLI process is requesting board access to this instance.
        </p>
