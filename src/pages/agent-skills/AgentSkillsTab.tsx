...
export function AgentSkillsTab({ agent, companyId }: { agent: Agent; companyId?: string }) {
  ...
  const unsupportedMessage = useMemo(() => {
    ...
    if (
      ...
      return "Parrot cannot manage skills for custom ACP commands yet.";
    }
    if (agent.adapterType === "openclaw_gateway") {
      return "Parrot cannot manage OpenClaw skills here. Visit your OpenClaw instance to manage this agent's skills.";
    }
    return "Parrot cannot manage skills for this adapter yet. Manage them in the adapter directly.";
