  ...
  const saveRoutine = useMutation({
    ...
    onError: (mutationError) => {
      ...
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Parrot could not save the routine.",
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (runError) => {
      pushToast({
        ...
        body: runError instanceof Error ? runError.message : "Parrot could not start the routine run.",
        tone: "error",
      });
    },
  });
  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (statusError) => {
      pushToast({
        ...
        body: statusError instanceof Error ? statusError.message : "Parrot could not update the routine.",
        tone: "error",
      });
    },
  });
  ...
  const createTrigger = useMutation({
    ...
    onError: (triggerError) => {
      pushToast({
        ...
        body: triggerError instanceof Error ? triggerError.message : "Parrot could not create the trigger.",
        tone: "error",
      });
    },
  });
  ...
  const updateTrigger = useMutation({
    ...
    onError: (triggerError) => {
      pushToast({
        ...
        body: triggerError instanceof Error ? triggerError.message : "Parrot could not update the trigger.",
        tone: "error",
      });
    },
  });
  ...
  const deleteTrigger = useMutation({
    ...
    onError: (triggerError) => {
      pushToast({
        ...
        body: triggerError instanceof Error ? triggerError.message : "Parrot could not delete the trigger.",
        tone: "error",
      });
    },
  });
  ...
  const rotateTrigger = useMutation({
    ...
    onError: (triggerError) => {
      pushToast({
        ...
        body: triggerError instanceof Error ? triggerError.message : "Parrot could not rotate the webhook secret.",
        tone: "error",
      });
    },
  });
