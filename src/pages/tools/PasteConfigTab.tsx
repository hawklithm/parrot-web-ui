 ...
 * approved Parrot template), so they get no hand-off here.
 */
        ...
        drafts.length === 0 ? (
          ...
          <div className="space-y-3">
            ...
            {drafts.some((d) => draftConnectUrl(d)) ? (
              <p className="text-xs text-muted-foreground">
                Checking a remote app creates a draft connection, stores any header replacements as Parrot secrets,
