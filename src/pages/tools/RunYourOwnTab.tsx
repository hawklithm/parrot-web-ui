 ...
 * Parrot will run in the company's isolated workspace and the keys it
  ...
  return (
    <div className="space-y-6">
      <p className="max-w-2xl text-sm text-muted-foreground">
        For a tool that runs from a command. Parrot runs it in your company's own isolated workspace.
        Administrators only.
      </p>
      ...
      <div className="space-y-5 rounded-lg border border-border bg-card p-5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="text-xs text-muted-foreground">
            Parrot will register the command and the keys it needs.
          </span>
        </div>
      </div>
