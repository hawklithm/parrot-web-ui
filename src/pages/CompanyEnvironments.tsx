      ...
      >
        <DialogContent className="flex max-h-(--sz-calc-18) flex-col gap-0 overflow-hidden p-0 sm:max-w-4xl">
          <DialogHeader className="border-b border-border/60 px-6 pb-4 pr-12 pt-6">
            ...
            <DialogDescription>
              Configure a reusable execution target for your agents. Saved changes affect future runs; Parrot may start fresh sessions or sandbox leases after environment config changes.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              {environmentForm.driver === "ssh" ? (
                <div className="grid gap-3 md:grid-cols-2">
                  ...
                  <Field label="Remote workspace path" hint="Absolute path that Parrot will verify during SSH connection tests.">
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                      type="text"
