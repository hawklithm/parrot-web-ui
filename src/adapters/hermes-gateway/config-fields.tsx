...
export function HermesGatewayConfigFields({
  ...
  return (
    <>
      <Field
        label="API base URL"
        hint="Hermes API server base URL that Parrot can reach, such as http://127.0.0.1:8642 or a private HTTPS URL. Default dashboard root/chat URLs such as http://127.0.0.1:9119/chat are accepted and map to /api."
      >
        <DraftInput
          value={apiBaseUrl}
      ...
      <Field
        label="Parrot API URL"
        hint="Optional Parrot API URL reachable by the Hermes host. This is not a credential."
      >
        <DraftInput
