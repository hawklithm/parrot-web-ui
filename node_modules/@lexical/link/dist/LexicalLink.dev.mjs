...
import { ElementNode, addClassNamesToElement, isHTMLAnchorElement, $copyNode, $isRangeSelection, $applyNodeReplacement, createCommand, $getSelection, $isNodeSelection, $findMatchingParent, $normalizeSelection__EXPERIMENTAL, $setSelection, $getChildCaret, $isElementNode, $insertNodeToNearestRootAtCaret, $rewindSiblingCaret, $caretFromPoint, $normalizeCaret, $isSiblingCaret, $setPointFromCaret, defineExtension, shallowMergeConfig, configExtension, mergeRegister, COMMAND_PRIORITY_EDITOR, PASTE_COMMAND, $isTextNode, COMMAND_PRIORITY_LOW, safeCast, isDOMNode, getNearestEditorFromDOMNode, $getNearestNodeFromDOMNode, TextNode, $isLineBreakNode, $createTextNode } from 'lexical';
import { defineImportRule, sel, $distributeInlineWrapper, CoreImportExtension, DOMImportExtension } from '@lexical/html';
...
const LinkExtension = /* @__PURE__ */defineExtension({
  ...
  CoreImportExtension, /* @__PURE__ */configExtension(DOMImportExtension, {
