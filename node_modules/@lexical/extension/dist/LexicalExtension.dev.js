 ...
 */
const AutoFocusExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 */
const ClearEditorExtension = /* @__PURE__ */lexical.defineExtension({
  build(editor, config, state) {
    return namedSignals(config);
  },
  config: /* @__PURE__ */lexical.safeCast({
 ...
 * Closes #8544.
 */
const ClickAfterLastBlockExtension = /* @__PURE__ */lexical.defineExtension({
...
const formatState = /* @__PURE__ */lexical.createState('format', {
 ...
 */
const DecoratorTextExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 */
const EditorStateExtension = /* @__PURE__ */lexical.defineExtension({
  build(editor) {
...
// `"0.46.0+dev.cjs"` is statically replaced with the build-specific
// version string in a Rollup build, and a consumer's bundler `define` can
// inject it the same way — so the exact `"0.46.0+dev.cjs"` member
 ...
 */
const InitialStateExtension = /* @__PURE__ */lexical.defineExtension({
  config: /* @__PURE__ */lexical.safeCast({
 ...
 */
const NodeSelectionExtension = /* @__PURE__ */lexical.defineExtension({
  build(editor, config, state) {
 ...
 */
const INSERT_HORIZONTAL_RULE_COMMAND = /* @__PURE__ */lexical.createCommand('INSERT_HORIZONTAL_RULE_COMMAND');
 ...
 */
const HorizontalRuleExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 *
 */
const IMEExtension = /* @__PURE__ */lexical.defineExtension({
  build(_editor) {
    return {
...
const NestedEditorExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 */
const NodeSelectionDataSelectedExtension = /* @__PURE__ */lexical.defineExtension({
  config: /* @__PURE__ */lexical.safeCast({
 ...
 */
const NormalizeInlineElementsExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 */
const NormalizeTripleClickSelectionExtension = /* @__PURE__ */lexical.defineExtension({
  build: (editor, config, state) => namedSignals(config),
  config: /* @__PURE__ */lexical.safeCast({
...
function captureKeydown(e) {
  ...
  if (lexical.isExactShortcutMatch(e, 'a', {
 ...
 */
const PreventSelectAllExtension = /* @__PURE__ */lexical.defineExtension({
  build: (editor, config, state) => namedSignals(config),
  config: /* @__PURE__ */lexical.safeCast({
    disabled: false
  }),
 ...
 */
const SelectBlockExtension = /* @__PURE__ */lexical.defineExtension({
  build: (editor, config, state) => namedSignals(config),
  config: /* @__PURE__ */lexical.safeCast({
  ...
  register: (editor, config, state) => {
    ...
    j(() => {
      ...
      if (!stores.disabled.value) {
        return editor.registerCommand(lexical.SELECT_ALL_COMMAND, (event, triggerEditor) => {
          ...
          if (lexical.$isNodeSelection(selection)) {
            ...
            if (!topParent || lexical.$isRootNode(topParent) || topParent.is(firstNode) ||
 ...
 */
const SelectionAlwaysOnDisplayExtension = /* @__PURE__ */lexical.defineExtension({
  build: (editor, config, state) => namedSignals(config),
  config: /* @__PURE__ */lexical.safeCast({
    disabled: false,
 ...
 */
const TabIndentationExtension = /* @__PURE__ */lexical.defineExtension({
  build(editor, config, state) {
    return namedSignals(config);
  },
  config: /* @__PURE__ */lexical.safeCast({
 ...
 */
const WatchEditableExtension = /* @__PURE__ */lexical.defineExtension({
  build(editor) {
