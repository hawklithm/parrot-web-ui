 ...
 * to the next.
 **/
const DOMRenderExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 */
const DOMImportExtension = /* @__PURE__ */lexical.defineExtension({
  build(editor, config) {
 ...
 * @experimental
 */
const CoreImportExtension = /* @__PURE__ */lexical.defineExtension({
 ...
 */
const HorizontalRuleImportExtension = /* @__PURE__ */lexical.defineExtension({
...
function $generateDOMFromNodes(container, selection = null, editor = lexical.$getEditor()) {
  return $withRenderContext([contextValue(RenderContextExport, true)], editor)(() => {
    ...
    const slotFrame = lexical.$isRangeSelection(selection) ? lexical.$getSlotFrame(selection.anchor.getNode()) : null;
