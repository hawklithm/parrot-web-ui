...
import { CommandPayloadType, EditorUpdateOptions, LexicalCommand, LexicalEditor, MapListeners, Transform } from './LexicalEditor';
...
export declare function triggerCommandListeners<TCommand extends LexicalCommand<unknown>>(editor: LexicalEditor, type: TCommand, payload: CommandPayloadType<TCommand>, fromEditor: LexicalEditor): boolean;
/**
