...
export { $caretFromPoint, $caretRangeFromSelection, $getAdjacentSiblingOrParentSiblingCaret, $getCaretInDirection, $getCaretRangeInDirection, $getChildCaretAtIndex, $insertNodeToNearestRootAtCaret, $isExtendableTextPointCaret, $normalizeCaret, $removeTextFromCaretRange, $rewindSiblingCaret, $setPointFromCaret, $setSelectionFromCaretRange, $splitAtPointCaretNext, $updateRangeSelectionFromCaretRange, type SplitAtPointCaretNextOptions, } from './caret/LexicalCaretUtils';
...
export type { AbstractStaticNodeConfigRecord, BaseStaticNodeConfig, DOMChildConversion, DOMConversion, DOMConversionFn, DOMConversionMap, DOMConversionOutput, DOMConversionProp, DOMConversionPropByTagName, DOMConversionTagNameMap, DOMExportOutput, DOMExportOutputMap, LexicalExportJSON, LexicalNode, LexicalUpdateJSON, NodeKey, NodeMap, SerializedLexicalNode, SlotChildNode, SlotHostNode, StaticNodeConfig, StaticNodeConfigAccessor, StaticNodeConfigRecord, StaticNodeConfigValue, StaticNodeTypeAccessor, } from './LexicalNode';
export { $isLexicalNode, buildImportMap } from './LexicalNode';
export { $getState, $getStateChange, $getWritableNodeState, $setState, type AnyStateConfig, createSharedNodeState, createState, NODE_STATE_DIRECT, NODE_STATE_LATEST, type NodeStateJSON, type NodeStateVersion, type StateConfig, type StateConfigKey, type StateConfigValue, type StateValueConfig, type StateValueOrUpdater, type ValueOrUpdater, } from './LexicalNodeState';
...
export { COLLABORATION_TAG, COMPOSITION_END_TAG, COMPOSITION_START_TAG, CUT_TAG, HISTORIC_TAG, HISTORY_MERGE_TAG, HISTORY_PUSH_TAG, PASTE_TAG, SKIP_COLLAB_TAG, SKIP_DOM_SELECTION_TAG, SKIP_SCROLL_INTO_VIEW_TAG, SKIP_SELECTION_FOCUS_TAG, type UpdateTag, } from './LexicalUpdateTags';
export { CAN_USE_BEFORE_INPUT, CAN_USE_DOM, IS_ANDROID, IS_ANDROID_CHROME, IS_APPLE, IS_APPLE_WEBKIT, IS_CHROME, IS_FIREFOX, IS_IOS, IS_SAFARI, } from './environment';
