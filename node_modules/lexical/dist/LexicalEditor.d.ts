...
import type { DOMConversion, DOMConversionMap, DOMExportOutput, DOMExportOutputMap, LexicalPrivateDOM, NodeKey } from './LexicalNode';
 ...
 */
export type DOMSlotForNode<N extends LexicalNode> = N extends ElementNode ? ElementDOMSlot<HTMLElement> : DOMSlot<HTMLElement>;
...
export interface EditorDOMRenderConfig {
     ...
     */
    $getDOMSlot: <N extends LexicalNode>(node: N, dom: HTMLElement, editor: LexicalEditor) => DOMSlotForNode<N>;
    /** @internal @experimental */
     ...
     */
    $getSlotTargetElement: <T extends LexicalNode>(node: T, slotName: string, hostDom: HTMLElement, editor: LexicalEditor) => HTMLElement | null;
    /** @internal @experimental */
 ...
 */
export declare function resetEditor(editor: LexicalEditor, prevRootElement: null | HTMLElement, nextRootElement: null | HTMLElement, pendingEditorState: EditorState, options?: ResetEditorOptions): void;
/** @internal */
...
export declare class LexicalEditor {
    ...
    /** @internal */
    constructor(editorState: EditorState, parentEditor: null | LexicalEditor, nodes: RegisteredNodes, config: EditorConfig, onError: ErrorHandler, onWarn: ErrorHandler, htmlConversions: DOMConversionCache, editable: boolean, createEditorArgs?: CreateEditorArgs);
    /**
     *
