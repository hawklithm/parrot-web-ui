 ...
 */
export declare function $splitAtPointCaretNext(pointCaret: PointCaret<'next'>, { $copyElementNode, $splitTextPointCaretNext, rootMode, $shouldSplit, removeEmptyDestination, }?: SplitAtPointCaretNextOptions): null | NodeCaret<'next'>;
/**
