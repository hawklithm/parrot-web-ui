...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "../../src/lib/paperclip-shared/src";
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter parrot-ui typecheck", "pnpm build-storybook"],
